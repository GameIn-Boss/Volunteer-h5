...
export const ADMIN_HOST = (`${window.apiHost}` == 'https://voladmin.taikang.com') || (`${window.apiHost}` == 'https://voladmin.taikang.com' )? 'https://voladmin.taikang.com' : 'https://voladmin.taikang.com';
// http://api.volzdx.cn
