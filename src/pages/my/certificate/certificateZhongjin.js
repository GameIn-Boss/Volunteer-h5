...
import "./certificateZhongjin.css";
    ...
    return (
      <div className="page-certificate-bg">
        <div className="page-certificate-container-border" ref="LaunchContent">
          <img src={this.state.bgImage || '/images/my/certificate-bgZhongjin.png'} className='page-certificate-bg-img' ref="bgImage"></img>
          ...
          <div className="page-certificate-container-hours-item-join_project_count">
            <span>{this.props.user.join_project_count}</span>
          </div>
          <div className="page-certificate-container-hours-item-reward_time">
            <span>{`${this.props.user.reward_time}`.length > 3 ? `${this.props.user.reward_time}`.split('.')[0] : `${this.props.user.reward_time}`}</span>
          </div>
