    ...
    return (
      <div className="page-certificate-bg">
        <div className="page-certificate-container-border" ref="LaunchContent">
          <img src={this.state.bgImage || '/images/my/certificate-bg-yg.png'} className='page-certificate-bg-img' ref="bgImage"></img>
          ...
          <div className="page-certificate-container-content-subtitle">
            您于{this.state.register}注册为阳光志愿者
          </div>
          ...
          <span className="page-certificate-container-hours-item-join_project_count_text">参加志愿服务项目 <span className="page-certificate-container-hours-item-join_project_count">{this.props.user.join_project_count}</span> 个</span>

          
          <span className="page-certificate-container-hours-item-reward_time-text">
          志愿服务时长 <span className="page-certificate-container-hours-item-reward_time">
         {`${this.props.user.reward_time}`.length > 3 ? `${this.props.user.reward_time}`.split('.')[0] : `${this.props.user.reward_time}`}</span> 小时</span>


          <div className="page-certificate-container-footer">
            <span>北京市阳光保险爱心协会</span>
