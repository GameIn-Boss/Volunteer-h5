  ...
  renderCertificate() {
    ...
    return (
      <div className="page-certificate-bg">
        ...
        <img src={this.state.bgImage || '/images/my/certificate-bghzzy.svg'} className='page-certificate-bg-img' ref="bgImage"></img>
          ...
          <div className="page-certificate-container-hours-box">
            <div className="page-certificate-container-hours">
              <div className="page-certificate-container-project-item">
          ...
          <div className="page-certificate-container-bottom-infobox">
            ...
            <div
              ...
              style={{paddingLeft: 135,marginTop: -180, paddingRight: 0, textAlign: "right", fontsize: "8px"}}
            >
              {this.state.now}
            </div>
