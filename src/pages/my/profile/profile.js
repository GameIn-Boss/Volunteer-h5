...
class Profile extends React.Component {
  ...
  renderRealInfo() {
    ...
    return (
      <div className="page-profile-bottom-real-info-container">
        <div className="page-profile-title page-profile-realinfo-padding-top">
          实名认证信息
        </div>
        {user.real_name ? (
          <div>
        ...
        <Link to="/my/profile/applyAlert">
          <div className="page-profile-apply-alert" onClick={this.applyAlert}>
            申请修改
          </div>
        </Link>
      </div>
  ...
  renderRealInfoExtends() {
    ...
    const user =
      userId === "user" ? this.props.user : this.props.otherfamily.data;
              ...
              switch (Number(item.type)) {
                ...
                case 1:
                  return (
                    <div key={index}>
                      <div className="page-profile-header-box">
                        <div className="page-profile-fonts-single">
                          {item.label}
                        </div>
                      </div>
        ...
        <div>
          ...
          <div className="page-profile-header-box">
            ...
            <div className="page-profile-header-uploade-box">
              <div
                className="page-profile-header-img-container"
                onClick={this.onAvatarClick}
              >
                <Avatar
                  src={this.photo ? this.photo : user.avatars}
          ...
          this.realRegister.real_name_register ? null : (
            <div className="page-profile-header-box">
    ...
    return (
      <div className="page-profile-header-detail">
        ...
        <div className="page-profile-header-box">
          <div className="page-profile-fonts">身份证号</div>
          <div className="page-profile-edit-right-box">
            {otherFamily.data.id_number.substring(0, 1)}***************
            {otherFamily.data.id_number.substring(17, 18)}
          </div>
        </div>
        <div className="line1px" />
        <div className="page-profile-header-box">
        ...
        <div className="page-profile-header-box">
          <div className="page-profile-fonts">详细地址</div>
          <div className="page-profile-edit-right-box">
            {otherFamily.data.addr}
          </div>
        </div>
        <div className="page-profile-header-cut" />
        <div className="page-profile-header-box">
        ...
        <div className="page-profile-header-box">
          ...
          <div className="page-profile-edit-right-box">
            <label htmlFor="relations">
              ...
              >
                {relations &&
                  relations.map((item, keys) => (
                    <option
                      value={item.name}
                      selected={
                        otherFamily.data.relation === item.name
                          ? "selected"
                          : ""
                      }
                      key={keys}
        ...
        {this.renderRealInfoExtends()}
        <div
          className="page-profile-edit-btn"
          onClick={() => {
  ...
  render() {
    ...
    return (
      <div>{userId === "user" ? this.renderHost() : this.renderNewView()}</div>
    );
  }
}
