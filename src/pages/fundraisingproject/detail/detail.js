...
class ProjectDetailPage extends React.Component {
                        ...
                        if (this.state.dialogType) {
                            ...
                            if (!customConfig && !paymentConfig && !stationConfig && !dateConfig&& !answerConfig) {
                                ...
                                if (answerConfig) {
                                    ...
                                    window.location.href = `/fundraisingproject/signup/${this.projectId}`;
                                }
    ...
    componentWillMount() {
        ...
        this.props.fundraisingprojectAction(this.projectId);
        ...
        if (action === "join") {
            ...
            if (!customConfig && !paymentConfig && !stationConfig && !stationDateConfig && !answerConfig) {
                ...
                if (answer_num !== 0) {
                    ...
                    window.location.href = `/fundraisingproject/signup/${projectId}`;
    ...
    renderBasic() {
        ...
        let actionLabel = t('立即捐款');
          
        let actionClassName = "project-action-available";
        let action = "join";
        ...
        return (
            <div>
                ...
                <div className="project-desc">{detailData.desc}</div>
                <div className="project-category">
                        <div style={{ color: "red", marginBottom: "4px" }}>
                          累计募集：  ¥ {detailData.already} 元
                        </div>
                    </div>
...
{newsData ? <MessagesItem data={newsData} /> :  <div className="page-circle-rendercommunity-info">
                                {t('还没有公告信息')}
                            </div> }
...
ProjectDetailPage.propTypes = {
    ...
    fundraisingprojectAction: PropTypes.func,
