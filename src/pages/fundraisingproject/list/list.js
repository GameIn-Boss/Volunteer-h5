...
import Projects from '../../../components/fundraisingproject/projects';
...
class ProjectListPage extends React.Component {
  ...
  onFilterChange(selectedOption) {
    ...
    window.location.href = `/fundraisingproject/list/type/${type}/category/${category}/target/${target}`;
  }
      ...
      <div className="page-project-list">
        <div className="header">
          <div className="search-bar-container">
            <Link className="component-search-bar" to="/fundraisingproject/search">
