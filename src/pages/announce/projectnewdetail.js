...
import { announceprojectDetailAction } from './announce.store';
...
class MessagesDetail extends React.Component {
  ...
  componentWillMount() {
    this.props.announceprojectDetailAction(this.Id);
  }
...
MessagesDetail.propTypes = {
  ...
  announceprojectDetailAction: PropTypes.func,
};
...
export default connect(
  ...
  dispatch => bindActionCreators({ announceprojectDetailAction }, dispatch),
)(MessagesDetail);
