...
class MessagesItemProject extends React.Component {
    ...
    return (
      <div>
        ...
        data.map((item,i) => (
          ...
          <Link to={item.jump_mode == 0 ? `/announcee/projectnewdetail/${item.id}` :item.herf } key={i}>
...
MessagesItemProject.title = '站内邮箱';

MessagesItemProject.propTypes = {
...
export default MessagesItemProject;
