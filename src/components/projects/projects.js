            ...
            return <li key={project.id}>
                <div>
                  ...
                  <Link to={`/project/detail/${project.id}`} className="project-main">
                    <Image className="image" src={(project.photo && porject.photo.length && Array.isArray(project.photo) && project.photo[0]) || project.list_photo} defaultSrc="/images/default_banner.png" alt="项目图片" />
